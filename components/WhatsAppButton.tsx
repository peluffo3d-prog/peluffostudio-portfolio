...
// TODO: reemplazar con el número real en formato internacional (ej: 5491112345678)
const WA_NUMBER = "549XXXXXXXXXX";
const WA_MSG    = encodeURIComponent("Hola! Vi su portfolio y quiero hablar sobre un proyecto.");
